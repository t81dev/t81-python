...
- Active tagged runtime contract baseline: `runtime-contract-v0.2`.
- Current migration runtime contract commit pin (`t81-vm/main`): `30306b32eea8b7acde1be354ed10d24881989225`.
- Runtime contract version at migration pin: `2026-02-08-v2`.
...
- CI coverage:
  ...
  - pinned lane against VM commit pin `30306b32eea8b7acde1be354ed10d24881989225`.
