...
- Latest tagged runtime contract baseline: `runtime-contract-v0.1`.
- Current migration runtime contract commit pin (`t81-vm/main`): `30306b3`.
...
- CI coverage:
  ...
  - pinned lane against VM commit pin `30306b3`.
